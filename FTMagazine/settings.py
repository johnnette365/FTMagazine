"""
Django settings for FTMagazine project.
...
ALLOWED_HOSTS = ['192.168.1.6', '127.0.0.1', '192.168.1.31']
...
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': 'full',  # You can customize this
        'height': 400,
        'width': '100%',
        'extraPlugins': ','.join([
            'codesnippet',  # Allows code formatting
...
WSGI_APPLICATION = 'FTMagazine.wsgi.application'
...
MEDIA_URL = '/media/'
# MEDIA_ROOT = [
#     # os.path.join(BASE_DIR, 'Megazine', 'Media'),
#     os.path.join(BASE_DIR, 'Magazine', 'Media'),
